...
class FSAMPLE(BaseModel):
    ...
    def forward(self, source, target, sample_list, iter=None):  # (b, t, n, f)
        ...
        dis_out = self.classif(dcgru4_state_tensor.reshape(t,b,n,-1).transpose(0, 1)) # 返回的x为(t*b*n,co) .clone()  .detach()
