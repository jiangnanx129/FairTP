...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout7_9_e3b.pt'.format(self._seed)
    ...
    def train_batch(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            loss4 = dynamic_cal5_global_no5_3(dis_labels, dis_out, sample_map, district_nodes)
            
            loss = loss1 + self.a_loss3*loss3 + self.a_loss4*loss4
            # print(loss1.requires_grad, loss3.requires_grad, loss4.requires_grad)
            ...
            if (batch_count+1)% time_T == 0:
                ...
                loss4_T, values_node = dynamic_cal5_global_T3(yl_global, self.district13_road_index, self._device)
                # 考虑动态公平的采样,124
