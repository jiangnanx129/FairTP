...
class D2STGNN_Engine(BaseEngine):
    def __init__(self, cl_step, warm_step, horizon, adj_mx, sam_num, T_dynamic, sample_num, district13_road_index, a_loss2, **args):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK_3_1e-2_fairst_5.pt'.format(self._seed)
    ...
    def train_batch(self, sample_list, time_T, yl_values, sample_map, district_nodes, epoch):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            loss2 = fairst_cal(new_pred, new_label, region_ratio)
