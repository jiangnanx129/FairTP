...
class DGCRN_Engine(BaseEngine):
    def __init__(self, step_size, horizon, criterion, d_lrate, model_params, D_params, optimizer_D, scheduler_D, a_loss3, a_loss4, \
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK5_new.pt'.format(self._seed)
    ...
    def train_batch(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            # print(dis_out.shape, yl_label.shape)
    ...
    def train(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values):
        ...
        filename = 'ylvalue_s{}_HK_3_1e-4_node_mape2_S_b42_T12.pkl'.format(self._seed)
