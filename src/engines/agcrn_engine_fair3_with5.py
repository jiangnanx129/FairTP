...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout6_4.pt'.format(self._seed)
    ...
    def train_batch(self, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            loss = loss1 + self.a_loss3*loss3 + self.a_loss4*loss4 + 0.0001*loss5 # HK 0.1, dis_lobel 0.01
            ...
            self._logger.info(loss_message.format(epoch + 1, batch_count+1, loss1, loss2_2, loss3, loss4, loss5, greater_than_zero, less_than_zero, equal_to_zero, benum, sanum,eqnum,  gmax_value, gmin_value, gav,gerror,  lmax_value, lmin_value,lav, lerror)) # , loss44))
