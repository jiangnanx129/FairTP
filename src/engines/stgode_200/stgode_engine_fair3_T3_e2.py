...
class STGODE_Engine(BaseEngine):
    def __init__(self, data_path, years, tpd, sigma, thres, criterion, d_lrate, model_params, D_params, optimizer_D, scheduler_D, a_loss3, a_loss4, \
                 adj_mx, T_dynamic, sample_num, district13_road_index, **args):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK5_6.pt'.format(self._seed)
    ...
    def train(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values):
        ...
        filename = 'ylvalue_s{}_HK_3_2e-3_node_mape2_S_T4.pkl'.format(self._seed)
