...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK_fairst_3.pt'.format(self._seed)
    ...
    def train_batch(self, district_nodes, epoch):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            loss3_2, loss3_1 = static_ifair(pred, district_nodes)
        
            
            out_static_loss, values_region = static_cal(new_pred, new_label, self._device) # 静态公平正则化
            #print(loss1,loss2_1, loss2_2, loss3_1, loss3_2) 
            loss = loss1 + self.a_loss2*loss2_1 + self.a_loss3*loss3_2 # BIG
