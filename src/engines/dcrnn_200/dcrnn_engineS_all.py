...
class FSAMPE_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HKALL_200_2.pt'.format(self._seed)
    ...
    def train(self, district_nodes):
        ...
        for epoch in range(self._max_epochs):
            ...
            message = 'Epoch: {:03d}, Train mape2: {:.4f}, Loss: {:.4f}, RMSE: {:.4f}, MAPE: {:.4f}, SFair: {:.4f}, DFair: {:.4f},  Valid mape2: {:.4f}, Loss: {:.4f}, RMSE: {:.4f}, MAPE: {:.4f}, SFair: {:.4f}, DFair: {:.4f}, Train Time: {:.4f}s/epoch, Valid Time: {:.4f}s, LR: {:.4e}'
    ...
    def evaluate(self, mode, district_nodes, epoch):
        ...
        if mode == 'val':
            ...
            log = 'Average Test mape2: {:.4f}, Test MAE: {:.4f}, RMSE: {:.4f}, MAPE: {:.4f}, SFair: {:.4f}, DFair: {:.4f}'
