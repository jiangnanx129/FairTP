...
class FSAMPE_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout7_999.pt'.format(self._seed) # _8i5
        torch.save(self.model.state_dict(), os.path.join(save_path, filename))
    
    def load_model(self, save_path):
        filename = 'final_model_s{}_HK3_disout7_999.pt'.format(self._seed)
    ...
    def train_batch(self, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator(): # 循环每一个batch
            ...
            print(loss1.requires_grad, pred.requires_grad, dis_out.requires_grad)
            pirnt()
            ...
            loss_message = 'Epoch: {:03d}, Batch_num:{:03d}, mape2:{:.4f}, Loss1: {:.4f}, Dis Loss: {:.4f}, Loss3: {:.4f}, Loss4: {:.4f},  Benefit: {:.4f}, Sacrifice: {:.4f}, Equal: {:.4f}, Be: {:.4f}, Sa: {:.4f}, Eq: {:.4f},  Bmax: {:.4f}, Bmin: {:.4f},Bmea: {:.4f}, Ber: {:.4f}, Smax: {:.4f}, Smin: {:.4f}, Smea: {:.4f},Ser: {:.4f}'  # , Loss44: {:.4f}
            self._logger.info(loss_message.format(epoch + 1, batch_count+1, mape2, loss1, loss2, loss3, loss4,  greater_than_zero, less_than_zero, equal_to_zero, benum, sanum,eqnum,  gmax_value, gmin_value, gav,gerror,  lmax_value, lmin_value,lav, lerror)) # , loss44))
    ...
    def train(self, sample_list, sample_map, sample_dict, district_nodes, yl_values):
        ...
        for epoch in range(self._max_epochs):
            ...
            t1 = time.time()
            mtrain_loss, mtrain_mape, mtrain_mape2, mtrain_rmse, mtraind_loss, mtrain_sfair, mtrain_dfair, mtrain_be, mtrain_sa, mtrain_eq, mtrain_ben, mtrain_san, mtrain_eqn \
            ...
            mvalid_loss, mvalid_mape, mvalid_mape2, mvalid_rmse, mvalidd_loss, mvalid_sfair, mvalid_dfair, mvalid_be, mvalid_sa, mvalid_eq, mvalid_ben, mvalid_san, mvalid_eqn\
            ...
            message = 'Epoch: {:03d}, Train, mape2: {:.4f}, Loss: {:.4f}, RMSE: {:.4f}, MAPE: {:.4f}, dis_loss: {:.4f}, SFair: {:.4f}, DFair: {:.4f}, Be {:.4f}, Sa {:.4f}, Eq {:.4f}, Bnum {:.4f}, Snum {:.4f},Enum {:.4f},Bmean {:.4f}, Smean {:.4f}, Time: {:.4f}s/epoch, LR: {:.4e}, D_LR: {:.4e}'
            ...
            message = 'Epoch: {:03d}, Test,  mape2: {:.4f}, Loss: {:.4f}, RMSE: {:.4f}, MAPE: {:.4f}, dis_loss: {:.4f}, SFair: {:.4f}, DFair: {:.4f},  Be {:.4f}, Sa {:.4f}, Eq {:.4f}, Bnum {:.4f}, Snum {:.4f},Enum {:.4f},Bmean {:.4f}, Smean {:.4f}, Time: {:.4f}s, LR: {:.4e}, D_LR: {:.4e}'
    ...
    def evaluate(self, mode, sample_list, sample_map, sample_dict, district_nodes, yl_values,epoch,total_nodes):
        ...
        with torch.no_grad():
            for X, label in self._dataloader[mode + '_loader'].get_iterator():
                ...
                mape2 = masked_mape(pred, label, single_mask_value).item()
                ...
                loss_message = 'Epoch: {:03d}, Batch_num:{:03d}, mape2:{:.4f}, Loss1: {:.4f}, Dis Loss: {:.4f}, Loss3: {:.4f}, Loss4: {:.4f}, Benefit: {:.4f}, Sacrifice: {:.4f}, Equal: {:.4f}, Be: {:.4f}, Sa: {:.4f}, Eq: {:.4f},  Bmax: {:.4f}, Bmin: {:.4f},Bmea: {:.4f}, Ber: {:.4f}, Smax: {:.4f}, Smin: {:.4f}, Smea: {:.4f},Ser: {:.4f}, region_mae:{}'  # , Loss44: {:.4f}
                self._logger.info(loss_message.format(epoch + 1, batch_count+1, mape2, loss1, loss2, loss3, loss4, greater_than_zero, less_than_zero, equal_to_zero, ebenum, esanum,eeqnum,  gmax_value, gmin_value, gav,gerror,  lmax_value, lmin_value,lav, lerror, loss_region)) # , loss44))
                ...
                edynamic_fair.append(loss4.item())
                loss_region_list.append(loss_region) # item是取标量值，只适合一个元素        
        ...
        if mode == 'val':
            ...
            return mvalid_loss, mvalid_mape, mvalid_mape2, mvalid_rmse, mvalidd_loss, mvalid_sfair, mvalid_dfair , mvalid_be, mvalid_sa, mvalid_eq, mvalid_ben, mvalid_san, mvalid_eqn, mvalid_bmean, mvalid_smean
            ...
            log = 'Average Test mape2: {:.4f}, MAE: {:.4f}, RMSE: {:.4f}, MAPE: {:.4f}, D_Loss: {:.4f}, SFair: {:.4f}, DFair: {:.4f},  Be {:.4f}, Sa {:.4f}, Eq {:.4f}, Bnum {:.4f}, Snum {:.4f},Enum {:.4f},Bmean {:.4f}, Smean {:.4f},.'
