...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout1_1b.pt'.format(self._seed)
    ...
    def train_batch(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            if batch_count >= (time_T-1):
                ...
                loss = loss1 + self.a_loss3 * loss3_mae + self.a_loss4 * loss4 #+ 1 * loss2 # HK 0.1, dis_lobel 0.01
                ...
                loss4 = -1
                loss = loss1 + self.a_loss3 * loss3_mae#+ 1 * loss2
            ...
            static_fair.append(loss3_mae.item()) # 区域静态损失
            static_fair2.append(loss3_mape.item())
            ...
            self._logger.info(loss_message.format(epoch + 1, batch_count+1, mape2, loss1, loss2, loss3_mae, loss4, loss3_mape)) # , loss44))
    ...
    def evaluate(self, mode, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values,epoch,total_nodes):
        ...
        with torch.no_grad():
            for X, label in self._dataloader[mode + '_loader'].get_iterator():
                ...
                estatic_fair2.append(loss3_mape.item())
