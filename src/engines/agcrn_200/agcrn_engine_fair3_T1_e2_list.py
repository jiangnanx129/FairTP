...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout7_16_e1.pt'.format(self._seed)
    ...
    def train_batch(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            # if batch_count>=(time_T-1):
                ...
                '''dynamic_cal5_global_no5_T原始的'''
                # loss4 = dynamic_cal5_global_no5_T(time_T, T_district_nodes, T_sample_map, T_disout)
                loss4, values_node = dynamic_cal5_global_no5_TT(self.district13_road_index, self._device, time_T, T_district_nodes, T_sample_map, T_disout)
