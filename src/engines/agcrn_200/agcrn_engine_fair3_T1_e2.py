...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout7_10_ee2l5.pt'.format(self._seed)
    ...
    def train_batch(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            if (batch_count+1)% time_T == 0:
                ...
                # 只用134,greedy, T_134
                # sample_list = \
                #     optimize_selection_T_134(self.district13_road_index, self.sample_num, values_region, values_node, self._device )
                
                # 134，但同级别，greedy
                # sample_list = \
                #     optimize_selection_T_134_equal(self.district13_road_index, self.sample_num, values_region, values_node, self._device )
