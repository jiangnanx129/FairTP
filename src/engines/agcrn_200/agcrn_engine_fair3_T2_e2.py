...
'''
对应1e-4. H4开头
MAE: 1.8889, Test RMSE: 3.1767, Test MAPE: 0.0371, Test SFair_mae: 1522.2770, Test DFair: 252.0626, Test SFair_mape: 30.7895
'''
...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK4_3.pt'.format(self._seed)
    ...
    def train(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values):
        ...
        filename = 'ylvalue_s{}_HK_3_1e-4_node_mape2.pkl'.format(self._seed)
        # 从文件中读取两个列表
