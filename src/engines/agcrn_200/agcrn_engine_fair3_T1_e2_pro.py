...
class AGCRN_Engine(BaseEngine):
    ...
    def save_model(self, save_path):
        ...
        filename = 'final_model_s{}_HK3_disout7_10_pro.pt'.format(self._seed)
    ...
    def train_batch(self, time_T, sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch, total_nodes):
        ...
        for X, label in self._dataloader['train_loader'].get_iterator():
            ...
            if (batch_count+1)% time_T == 0:
                ...
                loss4, values_node, values_node_count_global =\
                      dynamic_cal5_global_T4(yl_global, node_count_global, self.district13_road_index, self._device)
                ...
                sorted_dict = pro_sample2(values_region, values_node, values_node_count_global, self.district13_road_index)
                sample_list = resampel(sorted_dict,self.sample_num,self.district13_road_index)
                # 更新全局节点采样字典，键0-938值采过的次数
                node_count_global = calcute_global_dic(node_count_global, sample_list)
