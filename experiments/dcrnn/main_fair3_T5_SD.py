...
from src.engines.DCRNN_250.dcrnn_engine_fair3_T3_e2_SD import FSAMPE_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SD200_2.log'.format(args.seed))
    logger.info(args)
    logger.info("1e-3, static_cal, 0.01, 0.1")
