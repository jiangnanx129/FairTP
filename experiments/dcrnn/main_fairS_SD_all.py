...
from src.engines.DCRNN_250.dcrnn_engineS_SD_all import FSAMPE_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SDALL_200_5.log'.format(args.seed))
    logger.info(args)
    # logger.info("学习率不变")
    logger.info("5e-3, static_cal, bs48, sd_rn_adjall1")
