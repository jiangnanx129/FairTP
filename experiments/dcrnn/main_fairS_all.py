...
from src.engines.DCRNN_250.dcrnn_engineS_all import FSAMPE_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HKALL_200_2.log'.format(args.seed))
    logger.info(args)
    # logger.info("学习率不变")
    logger.info("1e-2, static_cal, bs48")
