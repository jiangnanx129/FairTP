...
from src.engines.dstagnn_200.dstagnn_engineS_SD import DSTAGNN_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SD_3_1e-4_S_b48.log'.format(args.seed))
    logger.info(args)
    logger.info("学习率不变")
