...
from src.engines.dgcrn_200.dgcrn_engineS_SD_all import DGCRN_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SD_3_1e-4_S_b42_T12_all2.log'.format(args.seed))
    logger.info(args)
    logger.info("学习率不变")
