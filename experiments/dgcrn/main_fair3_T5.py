...
from src.engines.dgcrn_200.dgcrn_engine_fair3_T3_e2 import DGCRN_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK5_new.log'.format(args.seed))
    logger.info(args)
    logger.info("不改变学习率。用的record_s2018_HK_3_1e-4_S_b42_T12，学习率默认")
