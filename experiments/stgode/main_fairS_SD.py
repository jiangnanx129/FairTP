...
from src.models.stgode_fair3_T import STGODE # 涉及到采样adj_list, baseline每T次重新采样！
from src.engines.stgode_200.stgode_engineS_SD import STGODE_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SD_3_2e-4_S2.log'.format(args.seed))
    logger.info(args)
...
def main():
    ...
    adj_path = '/home/data/xjn/23largest_baseline/LargeST/data/sd/sd_rn_adj.npy'
