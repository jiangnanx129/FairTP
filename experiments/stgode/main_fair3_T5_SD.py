...
from src.models.stgode_fair3_T2 import STGODE # 涉及到采样adj_list, baseline每T次重新采样！
from src.engines.stgode_200.stgode_engine_fair3_T3_e2_SD import STGODE_Engine
...
def get_config():
    ...
    logger.info(args)
    logger.info("改变学习率。用的ylvalue_s2018_SD_3_2e-3_node_mape2_S，学习率为默认")
    logger.info("用的模型：stgode_fair3_T2")
