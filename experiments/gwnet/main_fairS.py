...
from src.engines.gwnet_200.gwnet_engineS import GWNET_Engine
...
def get_config():
    ...
    parser.add_argument('--wdecay', type=float, default=1e-5) # 1e-4
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK_3_1e-4_S.log'.format(args.seed))
    logger.info(args)
    # logger.info("学习率不变")
