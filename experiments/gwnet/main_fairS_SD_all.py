...
# from src.engines.gwnet_200.gwnet_engineS_SD_all import GWNET_Engine
from src.engines.GWNET_250.gwnet_engineS_SD_all import GWNET_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SDALL_200_1.log'.format(args.seed))
    logger.info(args)
    # logger.info("学习率不变")
