...
from src.models.FairST_baseline.FairST import FairST
from src.engines.FairST_baseline.FairST_engineS2_all import FAIRST_Engine # fsample_engine5
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK_fairst_1.log'.format(args.seed)) # 日志保存位置 5,0.05,0.1
...
def main():
    ...
    model = FairST(node_num=node_num,
    ...
    engine = FAIRST_Engine(criterion = criterion,
