...
from src.engines.d2stgnn_200.d2stgnn_engineS_SD_all import D2STGNN_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SD_3_2e-3_S2_b24_all.log'.format(args.seed))
    logger.info(args)
    logger.info("学习率None")
