...
from src.engines.agcrn_200.agcrn_engine_fair3_T2_e2 import AGCRN_Engine # T1高效，T2三个list
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK4_3.log'.format(args.seed))
    logger.info(args)
