...
from src.engines.agcrn_engine_fair3_no5 import AGCRN_Engine
...
def get_config():
    ...
    parser.add_argument('--a_loss3', type=float, default= 0.01) # 0.2
    parser.add_argument('--a_loss4', type=float, default= 5) # 5
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK3_disout7_1b_test.log'.format(args.seed))
    logger.info(args)
