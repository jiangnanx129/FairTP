...
from src.engines.agcrn_200.agcrn_engine_fair3_T3_e2_SD_cf250 import AGCRN_Engine # T1高效，T2三个list
...
def get_config():
    ...
    parser.add_argument('--sam_num', type=int, default='250', help='sample sum')
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_SD5_1_cf250.log'.format(args.seed))
    logger.info(args)
