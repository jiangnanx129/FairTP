...
from src.engines.AGCRN_250.agcrn_engine_fair3_T3_e2 import AGCRN_Engine # T1高效，T2三个list
...
def get_config():
    ...
    parser.add_argument('--d_lrate', type=int, default=5e-3, help='dis lr') # 鉴别器lr
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK200_3.log'.format(args.seed))
    logger.info(args)
