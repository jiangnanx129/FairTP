...
from src.engines.stgcn_engine import STGCN_Engine
...
def main():
    ...
    adj_mx = adj_mx - np.eye(args.sam_num) #node_num)
    ...
    model = STGCN(node_num=args.sam_num, #node_num,
    ...
    engine = STGCN_Engine(device=device,
                        model=model,
