...
from src.models.astgcn_fair3_T import ASTGCN # 涉及到采样adj_list, baseline每T次重新采样！
from src.engines.astgcn_200.astgcn_engine_fair3_T3_e2 import ASTGCN_Engine
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK5_4.log'.format(args.seed))
    logger.info(args)
    logger.info("不改变学习率。用的record_s2018_HK_3_1e-3_S，学习率默认")
