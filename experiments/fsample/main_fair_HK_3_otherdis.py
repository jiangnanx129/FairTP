...
from src.engines.fsample_engine3 import FSAMPE_Engine # fsample_engine5
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_HK3_disout(-1-1)2.log'.format(args.seed)) # 日志保存位置 5,0.05,0.1
