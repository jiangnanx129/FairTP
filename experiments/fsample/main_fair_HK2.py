...
from src.models.fsample2 import FSAMPLE # fsample4
from src.engines.fsample_engine_gxhk import FSAMPE_Engine # fsample_engine5
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_e16.log'.format(args.seed)) # 日志保存位置 5,0.05,0.1
...
def main():
    ...
    if args.mode == 'train':
        ...
        engine.evaluate(args.mode,sample_list, sample_map, sample_dict, district_nodes, yl_values, epoch=1)
