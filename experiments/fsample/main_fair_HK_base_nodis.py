...
from src.models.fsample_base_nodis import FSAMPLE # fsample4
from src.engines.fsample_engine_base_nodis import FSAMPE_Engine # fsample_engine5
...
def get_config():
    ...
    logger = get_logger(log_dir, __name__, 'record_s{}_0925_1.log'.format(args.seed)) # 日志保存位置 5,0.05,0.1
