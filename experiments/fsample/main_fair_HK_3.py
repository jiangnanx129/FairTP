...
from src.engines.fsample_engine3_no5 import FSAMPE_Engine # fsample_engine5
...
def get_config():
    ...
    parser.add_argument('--a_loss4', type=float, default= 0.01)
    parser.add_argument('--types', type=str, default= "continue optional + greedy 2")
    args = parser.parse_args()

    log_dir = './experiments/{}/{}/'.format(args.model_name, args.dataset)
    # disout0-1，dislabel-1-1
    logger = get_logger(log_dir, __name__, 'record_s{}_HK3_disout7_999.log'.format(args.seed)) # _8i5 # 日志保存位置 5,0.05,0.1   3_disout7_8i3
...
def main():
    ...
    # for key, value in district13_road_index.items():
    #     print(key, len(value))
    ...
    if args.mode == 'train':
        ...
        epoch=1
        engine.evaluate(args.mode,sample_list, sample_map, sample_dict, district_nodes, args.yl_values, epoch, total_nodes)
